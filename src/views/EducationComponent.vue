<template>
    <div class="contentE">
        <div class="StudyNameWrap">
            <h1>Учёба</h1>
            </div>
                <div class="StudyInfoWrap">
                <p class="title">Севастопольский государственный университет</p>
                ...
                <thead>
                    ...
                    <tr>
                        <td>5</td>
                        <td><router-link active-class="active" to="/test">Высшая математика</router-link></td>
                        <td>ВМ</td>
                        <td>405</td>
                        <td>210</td>
                        <td>105</td>
